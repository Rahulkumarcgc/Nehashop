...
for (let line of lines) {
  ...
  if (parts.length >= 11) {
    ...
    // OMIT numericId so Postgres auto-handles it!
    let newTuple = `(${id}, ${name}, ${brand}, ${price}, ${oldPrice}, ${img}, ${rating}, ${cat}, ${desc}, ${isFeatured}, NOW())`;
...
fs.writeFileSync('output_artifact_auto.md', '```sql\n' + finalSQL + '\n```');
